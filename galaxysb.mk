...
DEVICE_PACKAGE_OVERLAYS := device/samsung/galaxysb/overlay

# These are the hardware-specific configuration files
PRODUCT_COPY_FILES := \
	device/samsung/galaxysb/asound.conf:system/etc/asound.conf \
	device/samsung/galaxysb/vold.fstab:system/etc/vold.fstab \
	device/samsung/galaxysb/egl.cfg:system/lib/egl/egl.cfg
...
# Prebuilt kl keymaps
PRODUCT_COPY_FILES += \
	device/samsung/galaxysb/cypress-touchkey.kl:system/usr/keylayout/cypress-touchkey.kl \
	device/samsung/galaxysb/sec_jack.kl:system/usr/keylayout/sec_jack.kl \
	device/samsung/galaxysb/aries-keypad.kl:system/usr/keylayout/aries-keypad.kl \
	device/samsung/galaxysb/s3c-keypad.kl:system/usr/keylayout/s3c-keypad.kl
...
PRODUCT_COPY_FILES += \
	...
	device/samsung/galaxysb/media_profiles.xml:system/etc/media_profiles.xml
